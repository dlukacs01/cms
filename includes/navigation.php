            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    while ($row = mysqli_fetch_assoc($select_all_categories_query)) {
                        ...
                        $pageName = basename($_SERVER['PHP_SELF']); // getting the name of the current page we are on (pl. category.php, index.php)
                    ...
                    if(isset($_SESSION['user_role'])) { // if we are logged in

                        if(isset($_GET['p_id'])) { // ha az edit oldalon vagyunk
