...
if(isset($_GET['delete'])) {
    ...
    if(isset($_SESSION['user_role'])) {
        ...
        if($_SESSION['user_role'] == 'admin') {
            ...
            $the_user_id = mysqli_real_escape_string($connection,$_GET['delete']); // cleaning data
            ...
            <?php
                ...
                while ($row = mysqli_fetch_assoc($select_users)) {
                    ...
                    echo "<tr>";
                        ...
                        echo "<td><a href='users.php?change_to_admin={$user_id}'>Admin</a></td>"; // sending multiple param in GET
