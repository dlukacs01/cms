...
<table class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th>Email</th>
                <th>Status</th>
                <th>In Response to</th> <!--title of the post the comment belongs to-->
                <th>Date</th>
                <th>Approve</th>
                <th>Unapprove</th>
                <th>Delete</th>
            ...
            <?php
                ...
                while ($row = mysqli_fetch_assoc($select_comments)) {
                    ...
                    echo "<tr>";
                        ...
                        echo "<td><a href='comments.php?approve=$comment_id'>Approve</a></td>"; // sending multiple param in GET
